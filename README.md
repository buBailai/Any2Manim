...
<p>
  ...
  <img src="https://img.shields.io/badge/version-v1.2.0-5B5BD6" alt="v1.2.0">
...
> ⚠️ **Windows 免安装包用户请把它解压到「纯英文路径」**（整条路径别含中文 / 全角空格）。内置的 LaTeX 对中文路径敏感，路径含中文会导致公式题渲染失败；纯英文目录名即可正常。即便如此，检测不到可用 LaTeX 时也会自动降级用 Text 写公式，不会让数理题彻底失败。
